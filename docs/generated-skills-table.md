...
| --- | ---: | --- | --- | ---: | --- |
| `ai-council` | 5.1.0 | foundation | active | 893 | True |
| `ai-humanize` | 2.4.0 | domain | active | 708 | False |
| `cometweb-context` | 1.2.0 | foundation | active | 584 | False |
...
| `evidence-researcher` | 1.0.1 | foundation | active | 741 | False |
...
| `skill-orchestrator` | 1.1.0 | foundation | active | 728 | False |
| `skill-orchestrator-multiagent` | 1.1.0 | foundation | active | 467 | False |
